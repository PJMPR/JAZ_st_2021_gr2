...
public class Timetable {
   ...
   @SequenceGenerator(
    ...
    public Timetable(int number, double capital, double interest, double fixedFee, double capitalToPay, double amount, CalculationParameters calculationParameters) {
        this.number = number;
