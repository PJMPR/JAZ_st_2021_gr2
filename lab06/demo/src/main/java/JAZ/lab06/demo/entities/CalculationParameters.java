...
public class CalculationParameters {
    ...
    @OneToMany(mappedBy = "calculationParameters", cascade = CascadeType.ALL, orphanRemoval = true)
    ...
    public CalculationParameters(int amount, int installmentCount, InstallmentType installmentType, double percentage, int fixedRate) {
        this.amount = amount;
