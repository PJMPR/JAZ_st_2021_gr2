...
public class QueryBuilder {
    public static String buildQuery(Optional<Long> id, Optional<String> title, Optional<Integer> language, Optional<Short> releaseYear,
                                    Optional<Short> rentalDuration, Optional<String> rentalRate, Optional<String> replacementCost) {
