...
public final class TimeUtil {
    ...
    public static Trigger buildTrigger(final Class jobClass, final SynchronizationInfo info){
    ...
    public static JobDetail buildJobDetail(final Class jobClass, final SynchronizationInfo info){
